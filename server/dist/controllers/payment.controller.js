...
class PaymentControls {
    storePaymentData(req, res) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o;
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const paymentDetails = new Payment_1.default({
                ...
                const mentorProfile = yield Mentor_1.default.findOneAndUpdate({ mentor_id: new mongodb_1.ObjectId((_j = req.body) === null || _j === void 0 ? void 0 : _j.mentor_id) }, { $inc: { spots: -1 } }, { new: true });
                //Creating the video call room for both user
                const roomExists = yield Room_1.default.findOne({
